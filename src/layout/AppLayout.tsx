...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-pink-950 text-white">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <svg className="w-4 h-4 text-pink-950" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-pink-200 z-50">
                      <div className="p-4 border-b border-pink-200">
                        <p className="text-sm font-medium text-pink-950">{user?.name || 'User'}</p>
      ...
      {/* Floating AI Button */}
      {isAIEnabled && isAuthenticated && location.pathname !== '/ai-chat' && (
        <Link
          to="/ai-chat"
      ...
      {activeUsers.length > 0 && isAuthenticated && location.pathname === '/' && (
        <div className="fixed bottom-6 left-6 bg-green-500 text-white px-4 py-2 rounded-full shadow-lg z-40">
          <div className="flex items-center gap-2">
            <div className="flex -space-x-2">
              {Array.from({ length: Math.min(activeUsers.length, 3) }).map((_, i) => (
                <div
                  key={i}
